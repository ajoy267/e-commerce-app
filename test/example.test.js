...
test('renderShoes should output HTML', (expect) => {
    ...
    const expected = '<div class="shoe-card"><h2>Nike ZoomX Vaporfly Next% 2</h2><img src="./assets/next.jpeg"><p>$250.00</p><button id="1" class="add-button">add to cart</button></div>';
    const next = shoes[0];
    //Act 
...
test('renderShoes should output HTML', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = '<div class="shoe-card"><h2>Nike Air Zoom Pegasus 38</h2><img src="./assets/pegasus.jpeg"><p>$120.00</p><button id="2" class="add-button">add to cart</button></div>';
